...
author: "Vinit Sehgal & Debasish Mishra, Texas A&M University"
date: "October/2023"
output:
...
<script>
   $(document).ready(function() {
     $head = $('#header');
     $head.prepend('<img src=\"./SampleData-master/images/TAMU_Box-Stack.jpg\" style=\"float: right;width: 150px;\"/>')
   });
</script>
```
...
<center>
![](./SampleData-master/images/blockwiseoperation2023.png){width=90%}
</center>
<br>
...
***
<center> __Data Visualization and Geospatial Analysis With R (2023)__ </center>
<center> Vinit Sehgal | Debasish Mishra </center>
<center> Texas A&M University </center>
<center> Correspondence: _vinit@tamu.edu_ (https://orcid.org/0000-0002-8837-5864) </center>
<center> ![](./SampleData-master/images/TAMU_Box-Stack.jpg){width=15%} </center>
